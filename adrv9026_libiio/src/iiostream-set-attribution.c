#include "../include/iiostream-set-attribution.h"
...
bool cfg_adrv9025_streaming_ch(struct stream_cfg *cfg, int chid)
{
	...
	long long rf_bandwidth = rd_ch_lli(chn, "rf_bandwidth");
	long long sampling_frequency = rd_ch_lli(chn, "sampling_frequency");
	printf("rf_bandwidth: %d sampling_frequency:%d\n", rf_bandwidth, sampling_frequency);
